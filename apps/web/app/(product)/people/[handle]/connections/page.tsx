...
export default function ConnectionsPage({ params, searchParams }: { params: Promise<{ handle: string }>; searchParams: Promise<{ type?: string }> }) {
  ...
  const kind: "followers" | "following" = search.type === "following" ? "following" : "followers";
